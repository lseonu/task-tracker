...
The composer reads the main-step PNG paths from `config/hackathon.json` under `assets.main_stepper_images`. If the art-team PNG for the current main step is missing, the composer omits the image instead of generating a placeholder.
