...
- Chat is the primary participant interface. Keep composer output text-only, including during the optional learning path; rich visuals come from the `devpost` MCP server on capable hosts.
