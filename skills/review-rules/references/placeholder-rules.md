...
Build a new application with OpenAI capabilities and ship it with Codex. The strongest entries should feel like products, not prompt wrappers. They should demonstrate a real user workflow, a credible problem choice, and a clear reason the application is better because of model capabilities.
