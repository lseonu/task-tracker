...
The selection is locally owned participant state (which event this project targets). Do not cache official dates, rules, or registration status here — later steps read those live per `references/plugin-runtime.md`.
