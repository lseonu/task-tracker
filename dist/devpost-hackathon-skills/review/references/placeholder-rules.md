...
Every participant should have access to the same essential information about eligibility, judging, required deliverables, deadlines, and submission expectations.

Do not present this draft as final legal copy.
...
Build a new application with AI capabilities and ship it with Codex. The strongest entries should feel like products, not prompt wrappers. They should demonstrate a real user workflow, a credible problem choice, and a clear reason the application is better because of model capabilities.

## What To Submit

Draft MVP checklist:

- A short text write-up explaining how AI capabilities are central to the product
...
- Projects that mention AI but do not show why model capabilities are central to the product
